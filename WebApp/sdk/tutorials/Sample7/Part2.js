var WILL = {
	...
	initInkEngine: function(width, height) {
		...
		this.strokesLayer = this.canvas.createLayer({width: width, height: height, scaleFactor: WILL.LAYER_SCALE_FACTOR});
		this.strokesAndCurrentStrokeLayer = this.canvas.createLayer({width: width, height: height, scaleFactor: WILL.LAYER_SCALE_FACTOR});
		...
		this.strokeRenderer = new Module.StrokeRenderer(this.canvas, {width: width, height: height, scaleFactor: WILL.LAYER_SCALE_FACTOR});
	...
	refresh: function(dirtyArea) {
		...
		var transformArea = Module.MatTools.transformRect(dirtyArea, this.transform, true);
		...
		// this.canvas.blend(strokesLayer, {transform: transform});
